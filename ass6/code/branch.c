            ...
            AccountAmount initialAmount)
{
  ...
  for (int i = 0; i < numBranches; i++) {
    ...
    sem_init(&branch->branch_sema, 0, 1);
    sem_init(&branch->branch_balance_sema, 0, 1);
