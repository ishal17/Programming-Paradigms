...
def getPlusScores(str1Align, str2Align):
	pscore = ""
	for i in xrange(0, len(str1Align)):
...
def getMinusScores(str1Align, str2Align):
	mscore = ""
	for i in xrange(0, len(str1Align)):
		if str1Align[i] == str2Align[i]:
			mscore += " "
...
def main():
	while (True):
		...
		plusScore = getPlusScores(str1Align, str2Align)
		minusScore = getMinusScores(str1Align, str2Align)
